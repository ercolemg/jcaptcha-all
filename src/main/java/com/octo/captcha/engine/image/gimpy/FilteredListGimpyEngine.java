...
public class FilteredListGimpyEngine extends com.octo.captcha.engine.image.ListImageCaptchaEngine {
    ...
    protected void buildInitialFactories() {
        ...
        // Inizializza i filtri JHLabs come BufferedImageOp
        ...
        CrystallizeFilter crystal = new CrystallizeFilter(); // Nota: corretta la classe, è "Crystallize", non "Crystalize"
